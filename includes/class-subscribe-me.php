...
class Subscribe_Me
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Subscribe_Me_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Subscribe_Me_Loader. Orchestrates the hooks of the plugin.
	 * - Subscribe_Me_i18n. Defines internationalization functionality.
	 * - Subscribe_Me_Admin. Defines all hooks for the admin area.
	 * - Subscribe_Me_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Subscribe_Me_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
